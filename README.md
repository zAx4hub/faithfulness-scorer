...
> Score answer faithfulness to sources

**Author:** zAx4hub

## Problem

Score answer faithfulness to sources. Teams often rely on closed SaaS, brittle scripts, or untested prototypes for this niche.

## Solution

`faithfulness-scorer` is an installable TypeScript/Node toolkit by **zAx4hub** with a real **ledger** engine, CLI, examples, and tests.
